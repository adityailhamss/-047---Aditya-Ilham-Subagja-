    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5">Tambah Officer</h1>
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <input type="text" name="name" id="tambah_name_officer"
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <input type="password" name="password" id="tambah_password_officer"
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <input type="password" name="password_confirmation" id="password_confirmation_officer"
