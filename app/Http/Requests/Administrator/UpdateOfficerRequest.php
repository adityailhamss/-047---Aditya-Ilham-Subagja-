...
class UpdateOfficerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required|email|unique:officers,email,'.$this->officer->id.'|min:3|max:255',
            'password' => 'nullable|confirmed|min:3|max:255',
            'phone_number' => 'required|numeric|unique:officers,phone_number,'.$this->officer->id.'|digits_between:3,255',
        ];
    }
